...
const ProfiliConsigliati = () => {
  const [profiles, setProfiles] = useState([])
  const [loading, setLoading] = useState(true)

  // Funzione per ottenere 9 profili casuali evitando duplicati
  const getRandomProfiles = (allProfiles, count = 9) => {
  ...
  const fetchRandomProfiles = async () => {
    try {
      ...
      if (response.ok) {
        ...
        const randomProfiles = getRandomProfiles(allProfiles, 9)
                ...
                <Row>
                  ...
                  <Col sm={10}>
                    ...
                    <Link
                      ...
                      className='btn btn-primary outline-dark rounded-pill'
                    >
                      Visualizza profilo
                    </Link>
                  </Col>
...
export default ProfiliConsigliati
